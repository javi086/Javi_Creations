...
// /******************************************************/
// import express, { raw, static, Router } from 'express';
// import cors from 'cors'; // I require it to avoid my error: "Access
// import { join } from 'path';
// import { Pool } from 'pg';
// const app = express();
// import Parser from 'rss-parser'; // This will be used to parse the RSS information into a JSON format that I can use in the frontend.
...
// /******************************************************/
// app.post('/webhook', raw({ type: 'application/json' }), async (request, response) => {
...
// app.use(static(join(__dirname, '../')));  // This must be first because, it tells Express to look for the static files from the parent directory (where index.html is).
// app.get('/', (req, res) => { // This gets the index.html file once the parent directory is set as the static folder (previous step)
//   res.sendFile(join(__dirname, '/index.html'));
// });
// const apiRouter = Router(); // This router will help me to organize the API endpoints.
